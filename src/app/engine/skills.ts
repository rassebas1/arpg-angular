...
export const SKILL_REGISTRY: Record<string, SkillDef> = {
  // Attacks
  'strike': { id: 'strike', name: 'Heavy Strike', description: 'A powerful single-target melee attack.', category: 'attack', baseDamage: 15, baseCooldown: 0.5, baseAoe: 2, color: '#ff4444' },
  'cleave': { id: 'cleave', name: 'Cleave', description: 'A sweeping attack that hits multiple enemies in front of you.', category: 'attack', baseDamage: 10, baseCooldown: 0.8, baseAoe: 3.5, color: '#ffaa00' },
  'leap': { id: 'leap', name: 'Leap Slam', description: 'Jump to a location, damaging enemies where you land.', category: 'attack', baseDamage: 12, baseCooldown: 2.0, baseAoe: 4, color: '#ff8844' },
  'whirlwind': { id: 'whirlwind', name: 'Whirlwind', description: 'Spin rapidly, damaging all nearby enemies.', category: 'attack', baseDamage: 8, baseCooldown: 0.3, baseAoe: 3, color: '#aaaaaa' },
  'smite': { id: 'smite', name: 'Smite', description: 'Strike an enemy and call down lightning.', category: 'attack', baseDamage: 18, baseCooldown: 1.0, baseAoe: 2.5, color: '#ffffaa' },
  
  // Spells
  'fireball': { id: 'fireball', name: 'Fireball', description: 'Shoots a flaming projectile.', category: 'spell', baseDamage: 20, baseCooldown: 1.0, baseProjectiles: 1, color: '#ff5500' },
  'nova': { id: 'nova', name: 'Frost Nova', description: 'An explosion of ice that damages all enemies around you.', category: 'spell', baseDamage: 15, baseCooldown: 1.5, baseAoe: 5, color: '#00aaff' },
  'arc': { id: 'arc', name: 'Arc', description: 'Lightning that chains between enemies.', category: 'spell', baseDamage: 18, baseCooldown: 1.2, baseAoe: 6, color: '#aa00ff' },
  'ice_spear': { id: 'ice_spear', name: 'Ice Spear', description: 'Fires a fast, piercing icy projectile.', category: 'spell', baseDamage: 25, baseCooldown: 0.8, baseProjectiles: 1, color: '#88ffff' },
  'meteor': { id: 'meteor', name: 'Meteor', description: 'Calls down a massive meteor from the sky.', category: 'spell', baseDamage: 40, baseCooldown: 3.0, baseAoe: 8, color: '#ff2200' },
